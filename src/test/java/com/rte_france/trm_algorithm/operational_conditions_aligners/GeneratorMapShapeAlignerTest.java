 ...
 */
class GeneratorMapShapeAlignerTest {
    ...
    void testAligningInjectionsMapShape() {
        ...
        GeneratorMapShapeAligner aligner = new GeneratorMapShapeAligner();
        aligner.align(referenceNetwork, marketBasedNetwork);

        assertEquals(55.0, marketBasedNetwork.getGenerator("F000011 _generator").getTargetP(), EPSILON);
        assertEquals(5.0, marketBasedNetwork.getGenerator("F000012 _generator").getTargetP(), EPSILON);
        assertEquals(10.0, marketBasedNetwork.getLoad("F000012 _load").getP0(), EPSILON);
        assertEquals(35.0, marketBasedNetwork.getLoad("F000013 _load").getP0(), EPSILON);
        assertEquals(90.0, marketBasedNetwork.getLoad("E000011 _load").getP0(), EPSILON);
        assertEquals(40.0, marketBasedNetwork.getLoad("E000012 _load").getP0(), EPSILON);
        assertEquals(95.8, marketBasedNetwork.getGenerator("E000012 _generator").getTargetP(), EPSILON);
        assertEquals(19.1, marketBasedNetwork.getGenerator("E000013 _generator").getTargetP(), EPSILON);
    }
    ...
    void testAligningInjectionsMapShapeWithCountry() {
        ...
        GeneratorMapShapeAligner aligner = new GeneratorMapShapeAligner(Country.FR);
        aligner.align(referenceNetwork, marketBasedNetwork);
    ...
    void testAligningInjectionsMapShapeCountriesVarargs() {
        ...
        GeneratorMapShapeAligner aligner = new GeneratorMapShapeAligner(Country.FR, Country.ES);
        aligner.align(referenceNetwork, marketBasedNetwork);
    ...
    void testAligningInjectionsMapShapeCountriesSet() {
        ...
        GeneratorMapShapeAligner aligner = new GeneratorMapShapeAligner(Set.of(Country.FR, Country.ES));
        aligner.align(referenceNetwork, marketBasedNetwork);
